// server/src/routes/admin/index.ts - UPDATED WITH STORAGE ROUTES
...
import adminPhotoRequestRoutes from './adminPhotoRequestRoutes.js';
import adminStorageRoutes from './adminStorageRoutes.js'; // NEW
...
router.use('/photo-requests', adminPhotoRequestRoutes);
router.use('/storage', adminStorageRoutes); // NEW - Storage management
