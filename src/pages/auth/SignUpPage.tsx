...
const SignUpPage: React.FC = () => {
  ...
  const benefits = [
    { icon: <Zap className='w-5 h-5' />, text: 'Instant US address' },
    { icon: <Shield className='w-5 h-5' />, text: '100% secure' },
    { icon: <Globe className='w-5 h-5' />, text: '45 days free storage' },
  ];
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 relative overflow-hidden'>
      ...
      <div className='fixed inset-0 overflow-hidden pointer-events-none'>
        ...
        />
        <motion.div
          className='absolute bottom-0 right-0 w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20'
          animate={{ x: [0, -100, 0], y: [0, -50, 0] }}
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-start'>
            ...
            >
              ...
              <p className='text-xl text-slate-600 mb-8 leading-relaxed'>
                Sign up in 2 minutes and start shopping from thousands of US
                stores. Your unique US shipping address will be ready instantly!
              </p>
      ...
      {/* Footer */}
      <div className='relative z-10 py-8 text-center text-sm text-slate-600'>
