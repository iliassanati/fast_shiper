      ...
      <div className='max-w-4xl mx-auto'>
        ...
        >
          ...
          <p className='text-xl text-slate-600'>
            Everything you need to know about Fast Shipper
          </p>
        </motion.div>
        ...
        <div className='space-y-4'>
          {faqs.map((faq, index) => (
            ...
            >
              <details className='group bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-slate-100 text-left'>
