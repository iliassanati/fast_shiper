// client/src/layouts/DashboardLayout.tsx - COMPREHENSIVE FIX
import {
  useAuthStore,
...
export default function DashboardLayout({
  ...
  // Calculate real badge counts from packages
  const badgeCounts = useMemo(() => {
    // Only count packages in storage (received status)
    const packagesInStorage = packages.filter(
      (p) => p.status === 'received'
    ).length;

    // Active shipments (pending or in transit)
  ...
  }, [packages, shipments, notifications]);
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      label: 'Packages',
      badge: badgeCounts.packagesInStorage, // Real count of packages in storage
      href: '/packages',
    },
    {
      id: 'shipments',
      ...
      label: 'Shipments',
      badge: badgeCounts.activeShipments, // Real count of active shipments
      href: '/shipments',
    },
    {
      id: 'profile',
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex'>
      ...
      <div className='flex-1 min-h-screen'>
        ...
        {/* Notification Modal (rendered outside header) */}
