// client/src/layouts/AdminLayout.tsx - UPDATED WITH PHOTO REQUEST BADGE
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const {
    photoRequestCounts,
    fetchPhotoRequestCounts,
    consolidationCounts, // NEW
    fetchConsolidationCounts, // NEW
  ...
  }, [fetchPhotoRequestCounts, fetchConsolidationCounts]);
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      badge: consolidationCounts.pending + consolidationCounts.processing, // NEW
    },
    {
      id: 'photo-requests',
      ...
      badge: photoRequestCounts.total, // 🔥 NEW: Badge count
    },
    {
      id: 'users',
      label: 'Users',
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex'>
        ...
        <nav className='p-4 space-y-2 flex-1 overflow-y-auto'>
          {menuItems.map((item) => (
            ...
            >
              ...
              {/* 🔥 NEW: Badge for collapsed sidebar */}
      ...
      <div className='flex-1 min-h-screen'>
        ...
        <header className='sticky top-0 z-30 bg-white bg-opacity-90 backdrop-blur-lg border-b border-slate-200 px-6 py-4'>
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-4 ml-6'>
              {/* Admin Notification Center - NOW WORKING! */}
              <AdminNotificationCenter variant='dropdown' />
            </div>
          </div>
        </header>
        ...
        <AdminNotificationCenter variant='modal' />
      </div>
