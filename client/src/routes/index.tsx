...
const AdminPackageDetailsPage = Loadable(
  lazy(() => import('@/pages/admin/AdminPackageDetailsPage'))
);
...
// 🔥 ADD THIS - Admin Shipment Details Page
const AdminShipmentDetailsPage = Loadable(
  lazy(() => import('@/pages/admin/AdminShipmentDetailsPage'))
);
...
export default function Router() {
  return useRoutes([
    ...
    // 🔥 NEW ROUTE - Admin Shipment Details
    {
      path: 'admin/shipments/:id',
      element: (
        <ProtectedRoute requireAdmin>
          <AdminShipmentDetailsPage />
        </ProtectedRoute>
      ),
    },
    {
