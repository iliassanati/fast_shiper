// client/src/pages/admin/AdminPhotoRequestsPage.tsx
...
export default function AdminPhotoRequestsPage() {
  ...
  const handlePhotoUpload = async (files: FileList | null) => {
    if (!files || !selectedRequest) return;
    ...
    try {
      ...
      await api.post(`/admin/photo-requests/${selectedRequest._id}/photos`, {
  ...
  const handleReportSubmit = async () => {
    if (!selectedRequest || !reportText.trim()) return;
          ...
          <div className='flex flex-col md:flex-row gap-4'>
            ...
            <div className='relative'>
              ...
              <select
                ...
                className='w-full md:w-64 pl-11 pr-4 py-3 border-2 border-slate-200 rounded-xl focus:border-blue-500 focus:outline-none appearance-none bg-white'
              >
                    ...
                    <td className='px-6 py-4'>
                      <select
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(
                          req.status
                        )} border-2 border-transparent focus:border-blue-500 focus:outline-none cursor-pointer flex items-center gap-1`}
                      >
          ...
          <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-6'>
            ...
            >
              ...
              <button
                ...
                disabled={uploading}
                className='w-full px-4 py-3 border-2 border-slate-300 rounded-xl font-semibold hover:bg-slate-50 transition-colors disabled:opacity-50'
              >
                Close
              </button>
            </motion.div>
            ...
            >
              ...
              <div className='flex gap-3'>
                ...
                <button
                  ...
                  className='flex-1 px-4 py-3 bg-purple-600 text-white rounded-xl font-semibold hover:bg-purple-700 disabled:opacity-50 transition-colors'
                >
                  Save Report
                </button>
              </div>
